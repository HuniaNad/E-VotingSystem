...
public class Profile2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
     ...
     private void displayData(){
        try{
            ...
            ageField.setValue(Integer.valueOf(result.getString("age")));
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        try{
            ...
            if(flag){
                if(check.CNICRepeats(cnicField.getText(), uid)){
                ...
                if(promptResult == JOptionPane.YES_OPTION){
                    Statement stmt = check.connectSQL();
                    String query = "UPDATE Person SET CNIC='"+cnic+"', AGE="+age+", FIRST_NAME='"+fname+"', LAST_NAME='"+lname+"', PHONE_NUMBER='"+phone+"',EMAIL='"+email+"',PASSWORD='"+pwd+"' where user_id='"+this.uid+"'";
