...
public class MyReg_elections extends javax.swing.JFrame {
private String uid;
    /**
     * Creates new form MyReg_elections
     */
    public MyReg_elections(String uid) {
        this.uid=uid;
    ...
    private void initComponents() {
        ...
        myregelections_label = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        regElections_table = new javax.swing.JTable();
        ...
        headerPanel.add(logoLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, 130, 80));
        ...
        myregelections_label.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        myregelections_label.setText("My Registered Elections");
        mainPanel.add(myregelections_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, -1, -1));

        regElections_table.setBackground(new java.awt.Color(244, 189, 108));
        regElections_table.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        regElections_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(regElections_table);
        if (regElections_table.getColumnModel().getColumnCount() > 0) {
            regElections_table.getColumnModel().getColumn(0).setResizable(false);
            regElections_table.getColumnModel().getColumn(1).setResizable(false);
        }

        mainPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, 690, 140));
 ...
 private void UpdateTable(){
          DefaultTableModel model = (DefaultTableModel) regElections_table.getModel();
        model.setRowCount(0);
        try{
         Checker check = new Checker();
           ...
           ResultSet result=stmt.executeQuery(sql);
            ...
            while (result.next())
            {
                ...
                DefaultTableModel tb1Model = (DefaultTableModel)regElections_table.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyReg_elections.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyReg_elections(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel myregelections_label;
    private javax.swing.JTable regElections_table;
