...
public class MainScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        headerPanel.add(ProfileLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 60, -1));
        ...
        resultsBtn.setBackground(new java.awt.Color(244, 189, 108));
        resultsBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Results.png"))); // NOI18N
        resultsBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                resultsBtnActionPerformed(evt);
            }
        });
        mainPanel.add(resultsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 320, 150, 110));

        electionBtn.setBackground(new java.awt.Color(244, 189, 108));
        electionBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/election.png"))); // NOI18N
        electionBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                electionBtnActionPerformed(evt);
            }
        });
        mainPanel.add(electionBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 150, 110));

        votingBtn.setBackground(new java.awt.Color(244, 189, 108));
        votingBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/voting.png"))); // NOI18N
        votingBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                votingBtnActionPerformed(evt);
            }
        });
        mainPanel.add(votingBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 200, 150, 110));

        groupsBtn.setBackground(new java.awt.Color(244, 189, 108));
        groupsBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/my groups.png"))); // NOI18N
        groupsBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                groupsBtnActionPerformed(evt);
            }
        });
        mainPanel.add(groupsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 320, 150, 110));
        ...
        headerLb.setText("Main Menu");
        mainPanel.add(headerLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 130, 200, 50));
    ...
    private void resultsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resultsBtnActionPerformed
        ...
        dispose();
        Results result = new Results(uid);
        result.setVisible(true);                //frame will only be visible with set "true"
        result.setLocationRelativeTo(null);     //for opening in center
    ...
    private void groupsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_groupsBtnActionPerformed
        // TODO add your handling code here
        dispose();
        MyGroups grp = new MyGroups(uid);
        grp.setVisible(true);                //frame will only be visible with set "true"
        grp.setLocationRelativeTo(null);     //for opening in center
