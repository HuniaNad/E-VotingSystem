...
public class Profile1 extends javax.swing.JFrame {
    ...
    private void displayData(){
        try{
            ...
            ResultSet result = stmt.executeQuery("Select * from Person where user_id='"+this.uid+"'");
            result.next();
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        try{
            ...
            Statement stmt = check.connectSQL();
            ResultSet result = stmt.executeQuery("Select * from Person where user_id='"+this.uid+"' and password='"+pwd+"'");
