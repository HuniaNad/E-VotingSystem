 ...
 * @author Hunia
 */
public class ElectionCreateEdit3 extends javax.swing.JFrame {
    private String uid;
    private static ArrayList<ArrayList<String>> data;
    
    /**
     * Creates new form ElectionScreen4
     */
    public ElectionCreateEdit3(String uid, ArrayList<ArrayList<String>> data) {
        this.uid = uid;
        this.data = data;
        initComponents();
        displayData();
    ...
    public void displayData(){
        try{  
            for(int i=0; i<data.size(); i++){
                if(data.get(i).get(0).equalsIgnoreCase("organization")){
                    organizationBtn.setSelected(true);
                } 
                else if(data.get(i).get(0).equalsIgnoreCase("government")){
                    governmentBtn.setSelected(true);
                }
                else if(data.get(i).get(0).equalsIgnoreCase("referendum")){
                    referendumBtn.setSelected(true);
                }
                else{
    ...
    private void initComponents() {
        ...
        electionCategoryGroup = new javax.swing.ButtonGroup();
        ...
        organizationBtn = new javax.swing.JRadioButton();
        referendumBtn = new javax.swing.JRadioButton();
        customBtn = new javax.swing.JRadioButton();
        governmentBtn = new javax.swing.JRadioButton();
        ...
        infoPanel.add(nameLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 470, 30));

        electionCategoryGroup.add(organizationBtn);
        organizationBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        organizationBtn.setText("Organization");
        infoPanel.add(organizationBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 120, 30));

        electionCategoryGroup.add(referendumBtn);
        referendumBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        referendumBtn.setText("Referendum");
        infoPanel.add(referendumBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 120, 30));

        electionCategoryGroup.add(customBtn);
        customBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        customBtn.setText("Custom");
        infoPanel.add(customBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 120, 30));

        electionCategoryGroup.add(governmentBtn);
        governmentBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        governmentBtn.setText("Government");
        governmentBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                governmentBtnActionPerformed(evt);
            }
        });
        infoPanel.add(governmentBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 120, 30));

        mainPanel.add(infoPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 190, 470, 200));

        headerLb.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        headerLb.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        headerLb.setText("Election Category");
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
        ...
        if(organizationBtn.isSelected()){
            ...
            dispose();
            ElectionCreateEdit3_1 organizationInfo = new ElectionCreateEdit3_1(uid, data);
            organizationInfo.setVisible(true);                //frame will only be visible with set "true"
            organizationInfo.setLocationRelativeTo(null);     //for opening in center
        }
        else if(governmentBtn.isSelected()){
            //ADD CODE
            
            dispose();
            ElectionCreateEdit3_2 governmentInfo = new ElectionCreateEdit3_2(uid, data);
            governmentInfo.setVisible(true);                //frame will only be visible with set "true"
            governmentInfo.setLocationRelativeTo(null);     //for opening in center
        }
        else if(referendumBtn.isSelected()){
            //ADD CODE
            
            dispose();
            ElectionCreateEdit3_3 referendumInfo = new ElectionCreateEdit3_3(uid, data);
            referendumInfo.setVisible(true);                //frame will only be visible with set "true"
            referendumInfo.setLocationRelativeTo(null);     //for opening in center
        }
            ...
            dispose();
            ElectionCreateEdit4 electionCreate = new ElectionCreateEdit4("custom", uid, data);
            electionCreate.setVisible(true);                //frame will only be visible with set "true"
            electionCreate.setLocationRelativeTo(null);     //for opening in center
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElectionCreateEdit3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElectionCreateEdit3(null, new ArrayList<>()).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.ButtonGroup electionCategoryGroup;
    private javax.swing.JPanel footerPanel;
    private javax.swing.JRadioButton governmentBtn;
    ...
    private javax.swing.JRadioButton organizationBtn;
    private javax.swing.JRadioButton referendumBtn;
