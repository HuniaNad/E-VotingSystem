 ...
 * @author Hunia
 */
public class ElectionCreateEdit3_1 extends javax.swing.JFrame {
    private String uid;
    private static ArrayList<ArrayList<String>> data;
    
    /**
     * Creates new form ElectionCreate3_1
     */
    public ElectionCreateEdit3_1(String uid, ArrayList<ArrayList<String>> data) {
        this.uid = uid;
        this.data = data;
        initComponents();
        displayData();
    ...
    private void initComponents() {
        ...
        headerPanel.add(HomeLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 40, 60, 20));
        ...
        headerLb.setText("Election Type - Organization");
        ...
        typeLb.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        typeLb.setText("Type");
        infoPanel.add(typeLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 40, 70, 30));

        typeField.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        typeField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Government", "Private", "Educational", "Vocational", "Humanitarian" }));
        infoPanel.add(typeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, 180, 30));

        nameLb.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        nameLb.setText("Name");
        infoPanel.add(nameLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 70, 30));
        infoPanel.add(nameField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 180, 30));

        mainPanel.add(infoPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 200, 530, 180));
    ...
    public void displayData(){
        try{           
            if(!data.isEmpty() && data.get(data.size()-1).get(0).equalsIgnoreCase("organization")){
                nameField.setText(data.get(data.size()-1).get(1));
                typeField.setSelectedItem(data.get(data.size()-1).get(2));
            }
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
        try{
            ...
            if(flag){
                ...
                dispose();
                ElectionCreateEdit4 electionCreate = new ElectionCreateEdit4("organization", uid, data);
                electionCreate.setVisible(true);                //frame will only be visible with set "true"
                electionCreate.setLocationRelativeTo(null);     //for opening in center
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElectionCreateEdit3_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElectionCreateEdit3_1(null, new ArrayList<>()).setVisible(true);
            }
        });
    }
