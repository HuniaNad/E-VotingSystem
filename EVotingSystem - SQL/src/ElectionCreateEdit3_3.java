 ...
 * @author Hunia
 */
public class ElectionCreateEdit3_3 extends javax.swing.JFrame {
    private String uid;
    private static ArrayList<ArrayList<String>> data;
    /**
     * Creates new form ElectionCreate3_3
     */
    public ElectionCreateEdit3_3(String uid, ArrayList<ArrayList<String>> data) {
        this.uid = uid;
        this.data = data;
        initComponents();
        displayData();
    ...
    private void initComponents() {
        ...
        statementLb = new javax.swing.JLabel();
        jScrollPane = new javax.swing.JScrollPane();
        statementField = new javax.swing.JTextArea();
        ...
        statementLb.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        statementLb.setText("Statement");
        infoPanel.add(statementLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 110, 60));

        statementField.setColumns(20);
        statementField.setRows(5);
        jScrollPane.setViewportView(statementField);

        infoPanel.add(jScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 290, 110));

        mainPanel.add(infoPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 200, 530, 220));

        headerLb.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        headerLb.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        headerLb.setText("Election Type - Referendum");
    ...
    public void displayData(){
        try{           
            if(!data.isEmpty() && data.get(data.size()-1).get(0).equalsIgnoreCase("referendum")){
                statementField.setText(data.get(data.size()-1).get(1));
            }  
        }catch(Exception ex){
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
        try{
            ...
            catData.add("referendum");
            catData.add(statement);
            ...
            dispose();
            ElectionCreateEdit4 electionCreate = new ElectionCreateEdit4("referendum", uid, data);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElectionCreateEdit3_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElectionCreateEdit3_3(null, new ArrayList<>()).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea statementField;
    private javax.swing.JLabel statementLb;
