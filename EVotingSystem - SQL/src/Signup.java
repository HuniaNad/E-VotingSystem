...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        headerLb.setText("Sign up");
        mainPanel.add(headerLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 140, 50));
        ...
        ageLb.setText("Age");
        loginPanel.add(ageLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130, 80, 30));

        ageField.setModel(new javax.swing.SpinnerNumberModel(18, 18, 100, 1));
        loginPanel.add(ageField, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 130, 90, 30));
        ...
        loginPanel.add(phoneField, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 280, 30));

        genderLb.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        genderLb.setForeground(new java.awt.Color(244, 189, 108));
        genderLb.setText("Gender");
        loginPanel.add(genderLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 180, 70, 30));
        ...
        loginPanel.add(passwordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 280, 30));

        cnicField.setText("xxxxx-xxxxxxx-x");
        loginPanel.add(cnicField, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 280, 30));
        ...
        neutralBtn.setBackground(new java.awt.Color(18, 30, 49));
        buttonGroup1.add(neutralBtn);
        neutralBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        neutralBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        loginPanel.add(neutralBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 240, 90, -1));

        femaleBtn.setBackground(new java.awt.Color(18, 30, 49));
        buttonGroup1.add(femaleBtn);
        femaleBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        ...
        loginPanel.add(femaleBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 180, 90, -1));

        maleBtn.setBackground(new java.awt.Color(18, 30, 49));
        buttonGroup1.add(maleBtn);
        maleBtn.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        ...
        loginPanel.add(maleBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 210, 90, -1));
        ...
        signupBtn.setForeground(new java.awt.Color(244, 189, 108));
        ...
        mainPanel.add(signupBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 460, 110, 30));
    ...
    private void signupBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupBtnActionPerformed
        try{
            ...
            if(check.isCNIC(cnicField.getText()) && !check.CNICRepeats(cnicField.getText(), null)){
                cnic = cnicField.getText();
                cnicField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 204, 0)));
            }
            else{
                cnicField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 51, 51)));
                flag = true;
            }
            ...
            if(flag){
                if(check.CNICRepeats(cnicField.getText(), null)){
                    cnicField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 51, 51)));
                    JOptionPane.showMessageDialog((Component)null, "CNIC already exists!");
                    flag = true;
                }
                else{
                ...
                int result = JOptionPane.showConfirmDialog(null,"Are you sure you want to sign up with these credentials?", "Sign up Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                if(result == JOptionPane.YES_OPTION){
                    IDGenerator idgen = new IDGenerator();
                    String uid = idgen.generateUID();
                    Statement stmt = check.connectSQL();
                    String query = "INSERT INTO Person (USER_ID, CNIC, AGE, FIRST_NAME, LAST_NAME, PHONE_NUMBER, EMAIL, PASSWORD, USER_TYPE, UTYPE_ID, GENDER) VALUES ('"+uid+"', '"+cnic+"', "+age+",'"+fname+"','"+lname+"','"+phone+"','"+email+"','"+pwd+"','User','ut', '"+gender+"')";
                    stmt.executeUpdate(query);
                    
                    JOptionPane.showMessageDialog((Component)null, "Sign up successful! Your User_ID is "+uid);
